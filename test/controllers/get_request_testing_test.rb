...
class GetRequestTest < Minitest::Test
  ...
  def test_registered_user_receives_200_status_when_viewing_application_details
    get '/sources/jumpstartlab/'

    assert_equal 200, last_response.status
  end

  def test_registered_user_receives_200_status_when_viewing_url_details
    get '/sources/jumpstartlab/urls/blog'

    assert_equal 200, last_response.status
  end

  def test_registered_user_receives_200_status_when_viewing_event_index
    get '/sources/jumpstartlab/events'

    assert_equal 200, last_response.status
  end

  def test_registered_user_receives_200_status_when_viewing_event_details
